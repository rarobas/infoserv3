!(function (e) {
  ...
  e.fn.jbvalidator = function (t) {
    ...
    let r = function (t, i) {
      ...
      u = function (a, i) {
        if ((e(a).removeClass(t.validClass), e(a).addClass(t.invalidClass), (i = e(a).data("vMessage") ?? i), t.errorMessage)) {
          let n = e(a).parent();
          if (e(n).length) {
            let a = e(n).find("." + t.invalidFeedBackClass);
            e(a).length ? e(a).html(i) : e(n).append('<div class="' + t.invalidFeedBackClass + '">' + i + "</div>");
          }
        }
      },
      c = function (a) {
        e(a).removeClass(t.invalidClass), t.successClass && e(a).addClass(t.validClass);
      },
      f = {
        multiSelectMin: function (t) {
          if ("SELECT" === e(t).prop("tagName") && e(t).prop("multiple")) {
            ...
            if (n < a && (e(t).prop("require") || n > 0)) return i.minSelectOption.sprintf(a);
          }
          return "";
        },
        multiSelectMax: function (t) {
          if ("SELECT" === e(t).prop("tagName") && e(t).prop("multiple")) {
            let a = e(t).data("vMaxSelect"),
              n = e(t).find("option:selected").length;
            if (n > a && (e(t).prop("require") || n > 0)) return i.maxSelectOption.sprintf(a);
          }
          return "";
        },
        equal: function (t) {
        ...
        customMin: function (t) {
          if (p(t, "data-v-min")) {
            let a = e(t).data("vMin"),
              n = e(t).val();
            if (isNaN(n) && (e(t).prop("require") || n.length > 0)) return i.number;
            if (n < a && (e(t).prop("require") || n.length > 0)) return i.minValue.sprintf(a);
          }
          return "";
        },
        customMax: function (t) {
          if (p(t, "data-v-max")) {
            let a = e(t).data("vMax"),
              n = e(t).val();
            if (isNaN(n) && (e(t).prop("require") || n.length > 0)) return i.number;
            if (n > a && (e(t).prop("require") || n.length > 0)) return i.maxValue.sprintf(a);
          }
          return "";
        },
        customMinLength: function (t) {
          if (p(t, "data-v-min-length")) {
            let a = e(t).data("vMinLength"),
              n = e(t).val().length;
            if (n < a && (e(t).prop("require") || n > 0)) return i.minLength.sprintf(a, n);
          }
          return "";
        },
        customMaxLength: function (t) {
          if (p(t, "data-v-max-length")) {
            let a = e(t).data("vMaxLength"),
              n = e(t).val().length;
            if (n > a && (e(t).prop("require") || n > 0)) return i.maxLength.sprintf(a, n);
          }
          return "";
        },
        fileMinSize: function (t) {
          if (p(t, "type", "file")) {
            ...
            for (let e = 0; e < t.files.length; e++) if (a && a > t.files[e].size) return i.fileMinSize.sprintf(a);
          }
          return "";
        },
        fileMaxSize: function (t) {
          if (p(t, "type", "file")) {
            ...
            for (let e = 0; e < t.files.length; e++) if (a && a < t.files[e].size) return i.fileMaxSize.sprintf(a);
          }
          return "";
        },
      },
      d = function (t) {
        if (t.validity.valueMissing) {
          if ("INPUT" === t.tagName) return void 0 === i.HTML5.valueMissing.INPUT[t.type] ? i.HTML5.valueMissing.INPUT.default : i.HTML5.valueMissing.INPUT[t.type];
          if (void 0 !== i.HTML5.valueMissing[t.tagName]) return i.HTML5.valueMissing[t.tagName];
        } else if (t.validity.typeMismatch) {
          if (void 0 !== i.HTML5.typeMismatch[t.type]) return i.HTML5.typeMismatch[t.type];
        } else if (t.validity.rangeOverflow) {
          if (void 0 !== i.HTML5.rangeOverflow[t.type]) {
            let e = t.getAttribute("max") ?? null;
            return ("date" !== t.type && "month" !== t.type) || (e = new Date(e).toLocaleDateString()), "week" === t.type && (e = "Week " + e.substr(6)), i.HTML5.rangeOverflow[t.type].sprintf(e);
          }
        } else if (t.validity.rangeUnderflow) {
          if (void 0 !== i.HTML5.rangeUnderflow[t.type]) {
            let e = t.getAttribute("min") ?? null;
            return ("date" !== t.type && "month" !== t.type) || (e = new Date(e).toLocaleDateString()), "week" === t.type && (e = "Week " + e.substr(6)), i.HTML5.rangeUnderflow[t.type].sprintf(e);
          }
        } else if (t.validity.stepMismatch) {
          if (void 0 !== i.HTML5.stepMismatch[t.type]) {
            let e = t.getAttribute("step") ?? null;
            return ("date" !== t.type && "month" !== t.type) || (e = new Date(e).toLocaleDateString()), "week" === t.type && (e = "Week " + e.substr(6)), i.HTML5.stepMismatch[t.type].sprintf(e, e);
          }
        } else {
          ...
          if (t.validity.badInput && void 0 !== i.HTML5.badInput[t.type]) return i.HTML5.badInput[t.type];
        }
    ...
    return (
      ...
      s(),
      {
        ...
        errorTrigger: function (e, t) {
          "object" == typeof e && (e = e[0]), e.setCustomValidity(t), u(e, e.validationMessage);
        },
        reload: function () {
          s();
        },
